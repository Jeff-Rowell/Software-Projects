/*
 * ============================================================================
 *   NOTE: The following changes were made to this file:
 *         - changed the namespace to CWMasterTeacher3
 *         - added diff_wordMode(string text1, string text2) -> line 220-236
 *         - removed the pillcrow character replacement in the ToString() 
 *           override
 *  NOTE:  All code in this file has been tested and the tests can be found at: 
 *         https://github.com/google/diff-match-patch/tree/master/csharp/tests
 * ============================================================================
 * 
  ...
  public class diff_match_patch {
    ...
    private short Match_MaxBits = 32;
        ...
        public List<Diff> diff_wordMode(string text1, string text2)
        {
            ...
            var a = dmp.diff_wordsToChars(text1, text2);
            var lineText1 = a[0];
            var lineText2 = a[1];
            var lineArray = a[2];
            var diffs = dmp.diff_main((string)lineText1, (string)lineText2, false);
            dmp.diff_charsToLines(diffs, (List<string>)lineArray);
            return diffs;
        }
      ...
      return chars.ToString();
                                          ...
                                          Dictionary<string, int> wordHash)
        {
            ...
            while (lineEnd < text.Length - 1)
            {
                ...
                if (wordHash.ContainsKey(line))
                {
                    chars.Append(((char)(int)wordHash[line]));
                }
                else
                {
                    wordArray.Add(line);
                    wordHash.Add(line, wordArray.Count - 1);
      ...
      return last_chars2 + (loc - last_chars1);
        ...
        public string diff_prettyHtml(List<Diff> diffs)
        {
            ...
            foreach (Diff aDiff in diffs)
            {
                ...
                {
                    case Operation.INSERT:
                        html.Append("<ins style=\"background:#a0ffa0;\">").Append(text)
                            .Append("</ins>");
                        break;
                    case Operation.DELETE:
